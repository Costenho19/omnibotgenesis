...
13. **TECHNICAL DIAGNOSTIC MODE [OVERRIDE]** - Para diagnósticos: línea de contexto ("Modo diagnóstico activado") + SOLO datos + métrica faltante + query SQL. Máximo 15 líneas.
