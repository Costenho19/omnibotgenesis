...
| ADRs publicados | **43** formalizados (incl. **ADR-134 Governance Oscillation & Hesitation Asymmetry Engine**, ADR-133 State Provenance Guard, ADR-132 SDK Public API v2.0.0, ADR-131 Execution Receipts, ADR-130 VC Trust Revocation Registry v2.2, ADR-129 Phase5 Anomaly Response Layer, ADR-128 Phase4 Calibration Insight Engine, ADR-127 Phase3 Filter Calibration Metrics, ADR-126 Receipt Archival HOT/WARM/COLD, ADR-125 Critical Core Tests, ADR-124 OSE, ADR-119 Governance Hardening, ADR-116 Fail-Closed Enforcement Policy, ADR-096 Canonical Receipt) |
| TAM total cubierto | $212B+ |
| Tests pasando | **472** confirmados (435 previos + 37 ADR-134 Oscillation v1.3 — T28b + T28c nuevos para AMPLIFYING+ASYMMETRY=CRITICAL) — suite completa pasa verde |
