...
| ADRs publicados | 39 formalizados (incl. **ADR-130 VC Trust Revocation Registry**, ADR-129 Phase5 Anomaly Response Layer, ADR-128 Phase4 Calibration Insight Engine, ADR-127 Phase3 Filter Calibration Metrics, ADR-126 Receipt Archival HOT/WARM/COLD, ADR-125 Critical Core Tests, ADR-124 OSE, ADR-119 Governance Hardening, ADR-116 Fail-Closed Enforcement Policy, ADR-096 Canonical Receipt) |
