...
- **React Build:** Siempre hacer `npm run build` en `omnix_web/` y commitear `dist/`. Railway sirve desde ahí.
...
- **14 invariantes totales:** ATF-INV-001–006 (RFC-ATF-1) + RGC-INV-001–008 (RFC-ATF-2).
