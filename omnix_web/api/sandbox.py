...
def _apply_critical_override(ai_result: dict, scenario_text: str) -> dict:
    ...
    critical_risk_terms = [
        ...
        'unmanned system', 'sistema no tripulado',
