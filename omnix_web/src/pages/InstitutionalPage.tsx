          ...
          <>
            <section className="text-center mb-20 animate-fade-in-up">
              ...
              <p className="text-xl text-muted max-w-3xl mx-auto mb-10 leading-relaxed">
                ...
                validates every decision before execution — with a post-quantum cryptographic receipt as proof. Currently live across 10 domains: digital asset trading, Islamic credit (UAE/GCC), global insurance claims, autonomous robotics, Medical AI, energy grids, real estate, autonomous agents, stablecoin reserve (MiCA/VARA compliant), and autonomous defense governance (IHL/LAWS). Every domain uses the same shared governance pipeline: 11 checkpoints including SIV, Monte Carlo, DCI, AML, Fraud Detection, and Jurisdiction gates.
              </p>
            ...
            <section className="mb-20">
              <div className="text-center mb-12">
                ...
                <p className="text-muted mt-4 max-w-2xl mx-auto">OMNIX integrates seamlessly with existing decision systems via REST API or webhooks. Currently governing decisions across 10 live domains: digital asset trading, Islamic credit, insurance claims, autonomous robotics, Medical AI, energy grids, real estate, autonomous agents, stablecoin reserve, and autonomous defense governance.</p>
              </div>
