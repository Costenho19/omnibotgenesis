          ...
          <>
            ...
            <section className="mb-20">
              <div className="text-center mb-12">
                ...
                <p className="text-muted mt-4 max-w-2xl mx-auto">OMNIX integrates seamlessly with existing decision systems via REST API or webhooks. Currently governing decisions across 7 live domains: digital asset trading, Islamic credit, insurance claims, autonomous robotics, Medical AI, autonomous agents, and more.</p>
              </div>
