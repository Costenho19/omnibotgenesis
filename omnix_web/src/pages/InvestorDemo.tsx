...
const TOOLS = [
  ...
  },
  {
    ...
    desc: 'Real-time view of every governance decision across all 4 verticals — updated every 10 seconds, no caching, no simulation.',
    tag: 'Live · 4 Verticals',
    link: '/command',
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto', padding: '2.5rem 1.5rem' }}>
          ...
          <div style={{
            ...
            {[
              ...
              { label: 'Active verticals', value: '4', color: '#a78bfa' },
