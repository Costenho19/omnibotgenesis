    ...
    <div className="min-h-screen bg-institutional">
      ...
      <main className="pt-32 px-6 pb-20 max-w-7xl mx-auto">
        ...
        <section className="glass-card p-10 text-center mb-16" style={{ borderColor: 'rgba(59, 130, 246, 0.3)' }}>
          ...
          <a href="https://wa.me/16504815494?text=Hi%2C%20I%20saw%20the%20insurance%20governance%20demo%20and%20I%27m%20interested" target="_blank" rel="noopener noreferrer" className="btn-primary inline-flex items-center gap-2">
