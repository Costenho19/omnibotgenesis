      ...
      <div style={{ maxWidth: 920, margin: '0 auto', padding: '56px 20px 80px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 72 }}>
          ...
          <p style={{ fontSize: 16, color: '#64748B', maxWidth: 600, margin: '0 auto 36px', lineHeight: 1.75 }}>
            Five historical crises. Real market signals. The same governance engine running in production today — applied retroactively to events that wiped hundreds of billions. Every decision is sealed in a cryptographic receipt you can verify independently.
          </p>
        ...
        <div style={{ textAlign: 'center', padding: '8px 0' }}>
          <p style={{ fontSize: 11, color: '#374151', lineHeight: 1.8, maxWidth: 560, margin: '0 auto 16px' }}>
            Receipts generated by <code style={{ color: '#475569' }}>GovernanceReplayEngine v1.0.0</code> — the same governance engine deployed in OMNIX production. Receipt IDs and canonical hashes are deterministic: identical inputs always produce identical outputs. ADR-145 · May 2026.
          </p>
