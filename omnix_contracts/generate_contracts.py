...
def build_contract():
    ...
    sections = [
        ...
        ("13. GOVERNING LAW",
         "This Agreement is governed by the laws of the State of Delaware, United States. Any disputes shall be resolved by binding arbitration under the rules of the American Arbitration Association."),
    ]
