...
try:
    from adaptive_weight_system import AdaptiveWeightSystem, create_adaptive_system, interpret_regime
...
try:
    from conversational_brain import get_conversational_brain
...
class AutoTradingBot:
    ...
    def __init__(self, trading_service, database_service=None, advanced_features=None, paper_trading=None, ai_service=None, ares_v1=None, ares_v2=None):
        ...
        self.config = {
            ...
            'max_position_pct': 0.80,  # Máximo 80% del balance por trade (agresivo para generar trades)
            'stop_loss_pct': 0.025,  # Stop-loss 2.5% (protección tight profesional)
            'max_daily_loss_pct': 0.10,  # Parada si pérdida diaria > 10% (ajustado para balance bajo)
            'min_confidence': 0.15,  # Confianza mínima 15% (MÁS AGRESIVO para generar más trades)
