...
- [Bot Prompt Architecture](bot-prompt-architecture.md) — ADR count real: 136 archivos, último ADR-199. Arquitectura ATF/BEV/OGR/MIVP/PoGR/OGI es PÚBLICA (6 RFCs con DOI). Solo propietario: internals del trading engine (SIV/FTI/TCV/QME/pesos).
