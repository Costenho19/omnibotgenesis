...
*Version 1.6 · May 19 2026 — Canonical freeze: 47 active invariants across 9 families, 171 ADRs (ADR-001→171), 245+ tests passing, RFC-ATF-1/2/3 published with 6 permanent DOIs. All stale counts corrected across full documentation corpus. This is the authoritative version for due diligence and institutional review.*
