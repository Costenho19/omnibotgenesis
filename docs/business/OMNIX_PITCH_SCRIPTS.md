...
| Rule | Requirement |
|------|-------------|
| Category Name | "Decision Governance Infrastructure" |
| Canonical Definition | "governance control architecture for automated decision systems" |
...
| Phrase | Why |
|--------|-----|
| "Global leader in Decision Governance" | Supremacy claims — use "building" |
| "We created a new category" | Past tense implies market recognition — use "building" |
| "AI-powered trading bot" | Wrong competitive set |
| "Guaranteed returns" / "beat the market" | Illegal / unproven |
| "Stripe of governance" / "Palantir of X" | Sounds pitchy — use structural analogy instead |
| "We are the first" (without qualifier) | Unverifiable — use "first validated vertical" |

### Metrics — Locked (Zero Tolerance for Deviation)
...
Without this, "infrastructure" sounds theoretical. With it, it sounds proven.
...
> La automatización está creciendo más rápido que la gobernanza.
>
...
## VERSION B — 60 SECONDS (Elevator / Networking)

### English

> Automation is growing faster than governance. Systems execute decisions automatically, but almost none have a real control layer that evaluates those decisions before execution.
>
...
> La automatización crece más rápido que la gobernanza. Los sistemas ejecutan decisiones automáticamente, pero casi ninguno tiene una capa de control real que las evalúe antes de ejecutarlas.
>
...
### Timing Breakdown — 90-Second Version
...
| **Close** | 80-90s | "OMNIX — governing decisions under uncertainty." | Final. No smile needed. Let it land. |

### Timing Breakdown — 60-Second Version

| Section | Time | Content |
|---------|------|---------|
| **Hook** | 0-8s | Problem statement |
| **Identity** | 8-15s | Category declaration |
| **Architecture** | 15-25s | How it works (checkpoints, fail-closed) |
| **Evidence** | 25-35s | Numbers + validated vertical |
| **Expansion** | 35-45s | Domain-agnostic, multi-vertical |
| **Ask + Close** | 45-60s | $500K, regulatory window, tagline |
...
| "We're building it" | Direct. Confident. No hedging. |
| "Governing decisions under uncertainty" | Final line. Slow. No trailing off. |

### Anti-Abstraction Checklist

Every pitch version MUST pass this test. Check each line:
...
| Says "first validated in digital asset trading" | Present in all 4 versions |
