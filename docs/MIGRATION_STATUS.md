...
> Para cambios post-febrero 2026 (incluyendo Checkpoint 7 — TCV, ADR-032; y CP-6 — Sharia Gate, ADR-046, Mar 25 2026), ver [REAL_SYSTEM_STATUS.md](REAL_SYSTEM_STATUS.md), [ADR-032](reference/adr/ADR-032-temporal-coherence-validation.md) y [ADR-046](reference/adr/ADR-046-sharia-governance-gate.md).
>
> **Mar 25, 2026 — CP-6 Sharia Governance Gate (ADR-046):** Pipeline de trading bot completo. CP-6 asignado al Sharia Governance Gate entre CP-5 y CP-7. Fail-safe, deshabilitado por defecto. Ver REAL_SYSTEM_STATUS.md para detalles completos.
...
| Tests totales | **164** (10 críticos en CI, resto integración/ports) |
