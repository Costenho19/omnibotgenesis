...
The **OMNIX Governance Intelligence (OGI)** is a domain-expert language model fine-tuned on the complete OMNIX protocol corpus — 194 ADRs, 6 published RFCs, 125 formal invariants, and 13 corpus categories including the full Mandate Integrity Verification Protocol (MIVP) vocabulary.
...
- All 125 invariant codes with their ADR source
