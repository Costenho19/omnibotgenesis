...
const differentiators = [
  {
    ...
    evidence: "Probe Report firmado en cada evaluación · Historial de 50 intentos por dominio · Detectable en auditoría post-incidente",
  ...
  },
  {
    ...
    evidence: "NUA Report JSON en cada packet · Score 0–100 de naturalidad · Señales sospechosas listadas explícitamente",
  ...
  },
  {
    ...
    evidence: "Campo genealogy en cada receipt · Hash del padre embebido antes del content_hash · Compatible con receipts anteriores sin migración",
  ...
  },
  {
    ...
    evidence: "CCS en cada integrity report · Umbrales: COMPLETE ≥ 90 · DEGRADED ≥ 70 · PARTIAL ≥ 50 · COMPROMISED < 50",
    ...
    >
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "60px 40px 80px" }}>
        ...
        >
          ...
          OMNIX lo demuestra: cada decisión produce artefactos verificables,
          firmados criptográficamente, que existen independientemente de la plataforma.
        </p>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 14, color: "#64748b", margin: 0, maxWidth: 460 }}>
              Cada evaluación en OMNIX produce un receipt PQC-firmado que puedes verificar
              de forma independiente, sin acceso al sistema. Agenda una demo de 30 minutos.
            </p>
          </div>
        ...
        >
          ...
          <div style={{ fontSize: 12, color: "#334155" }}>
            Dilithium-3 (ML-DSA-65) · PQC-First · 151 ADRs
          </div>
        </div>
      </div>
    </div>
