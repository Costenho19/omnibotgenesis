...
def generate_canvas(mentor_name, output_path):
 ...
 elements.append(Paragraph(" GCC 2026 \u2014 Semifinalist", info_style))
 elements.append(Spacer(1, 8))
 ...
 elements.append(Paragraph(" Aligned | March 2026", date_style))
 elements.append(Paragraph("Classification: Competition Supplement \u2014 Expert Reviewed", date_style))
 elements.append(Paragraph("Alignment: All numbers match the OMNIX investor pitch deck
 ...
 "OMNIX \u2014 2026 Semifinalist | Pre-Seed: $500K @ $2.5M\u2013$3M valuation (16.7% equity) | "
 ...
 [' (current)', 'Competition exposure + judge intros', 'Immediate pipeline'],
 ]
 ...
 ['Alignment', 'All numbers match OMNIX investor pitch deck
...
def generate_pitch_deck(mentor_name, output_path):
 ...
 roadmap_items = [
 "<b>Q1 2026 (Current):</b> Complete track record validation. competition. Execution Integrity v1 (Kraken fill verification). Mathematical audit (100% P&L reconciliation).",
...
def generate_investor_report(mentor_name, output_path):
 """Generate a basic investor report for the given mentor."""
 ...
 elements.append(Paragraph("OMNIX", styles['Title']))
 elements.append(Paragraph("Decision Governance Infrastructure for Automated Systems", styles['Heading2']))
 elements.append(Spacer(1, 20))
 elements.append(Paragraph(f"Prepared for: {mentor_name}", styles['Normal']))
 elements.append(Spacer(1, 10))
 elements.append(Paragraph("Founder & CEO: Harold Nunes", styles['Normal']))
 elements.append(Paragraph("Pre-Seed Round: $500,000 USD @ $3M valuation", styles['Normal']))
 elements.append(Spacer(1, 10))
 elements.append(Paragraph("contacto@omnixquantum.net", styles['Normal']))
 elements.append(Paragraph("www.omnixquantum.net", styles['Normal']))
