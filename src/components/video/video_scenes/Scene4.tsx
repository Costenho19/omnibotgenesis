...
// S4 duration: 15000ms
// Narrative: What happens when someone tampers with the evidence?
// The system halts. Provably.
...
export function Scene4() {
  ...
  useEffect(() => {
    const timers = [
      ...
      setTimeout(() => setPhase(2), 2000),  // hash appears
  ...
  return (
    ...
    >
      ...
      {/* FAIL messages */}
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2vh', zIndex: 10, marginBottom: '6vh' }}>
        <motion.p
          style={{
            fontFamily: "'JetBrains Mono', monospace",
            fontSize: '2.2vw',
      ...
      >
        ...
        >
          The governance contract proved the halt is mandatory —
        </p>
        <p
          style={{
            fontFamily: "'Plus Jakarta Sans', sans-serif",
        ...
        >
          without accessing any OMNIX server.
        </p>
      </motion.div>
    </motion.div>
  );
