...
TOOLS = [
 ...
 "Keep file size under 100MB for easy upload to investor submission portal."),
]
...
class DemoGuidePDF(FPDF):
 ...
 self.set_xy(10, 2)
 self.cell(0, 8, "OMNIX — Demo Video Guide | 2026", align="L")
 self.ln(4)
...
def generate():
 ...
 pdf.set_xy(10, 30)
 pdf.cell(0, 8, "90-Second Product Demo | 2026 Submission", align="L")
 pdf.set_xy(10, 40)
 ...
 "The video can be submitted to 2026 as supporting evidence of a live, working system. "
