...
def build_pdf():
 ...
 elements.append(Paragraph(" preparation and presentation materials", h3))
 timeline_items_4 = [
 "Created complete pitch deck with professional slides for (March 18)",
 ...
 docs_list = [
 "Pitch deck for (March 18 presentation)",
 ...
 ['Target event', '', 'March 18, 2026 — Semifinalist'],
 ],
